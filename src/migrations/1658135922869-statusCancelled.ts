...
export class statusCancelled1658135922869 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."reservation_status_enum" AS ENUM('PENDING', 'CREATED', 'UPDATED', 'CANCELLED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."reservation_status_enum_old" AS ENUM('PENDING', 'CREATED', 'UPDATED')`);
        await queryRunner.query(`ALTER TABLE "reservation" ALTER COLUMN "status" DROP DEFAULT`);
